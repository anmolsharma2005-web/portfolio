  ...
  return (
    <div className="w-full lgl:w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b] p-4 lgl:p-8 rounded-lg shadow-shadowOne flex flex-col gap-8 justify-center">
      ...
      <div className="flex flex-col gap-4">
        <h3 className="text-3xl font-bold text-white">Anmol Sharma</h3>
        ...
        <p className="text-base text-gray-400 flex items-center gap-2">
          Phone: <span className="text-lightText">+91 9718401731</span>
        </p>
        <p className="text-base text-gray-400 flex items-center gap-2">
          Email:{" "}
          <span className="text-lightText">anmolsharma18022005@gmail.com</span>
        </p>
      </div>
      <div className="flex flex-col gap-4">
        ...
        <div className="flex gap-4">
          <span className="bannerIcon">
            <a
              href="https://www.facebook.com/anmol.don.52056"
              target="_blank"
          ...
          <span className="bannerIcon">
            <a
              href="https://www.linkedin.com/in/anmol-sharma-42ba03391/?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
              target="_blank"
              rel="noopener noreferrer"
            >
              <FaLinkedinIn />
          ...
          <span className="bannerIcon">
            <a
              href="https://github.com/anmolsharma2005-web"
              target="_blank"
              rel="noopener noreferrer"
            >
              <FaGithub />
