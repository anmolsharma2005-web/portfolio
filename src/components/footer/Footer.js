      ...
      <div className="w-full h-full flex flex-col gap-8">
        ...
        <div className="flex gap-4">
          <span className="bannerIcon">
            <FaFacebookF url="https://www.facebook.com/anmol.don.52056" />
          </span>
          <span className="bannerIcon">
            <FaLinkedinIn url="https://www.linkedin.com/in/anmol-sharma-42ba03391/?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" />
          </span>
          <span className="bannerIcon">
            <FaGithub url="https://github.com/anmolsharma2005-web" />
          </span>
        </div>
      </div>
